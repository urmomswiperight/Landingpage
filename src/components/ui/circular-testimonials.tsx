...
export const CircularTestimonials = ({
  ...
  const colorTestimony = colors.testimony ?? "#e5e7eb";
      ...
      <div className="grid md:grid-cols-2 gap-20">
        ...
        <div className="relative w-full h-[24rem] [perspective:1000px]" ref={imageContainerRef}>
          {testimonials.map((testimonial, index) => {
            const isImage = testimonial.src.startsWith("http");
            return isImage ? (
              <img
                key={testimonial.src}
                src={testimonial.src}
              ...
              <div
                ...
                className="absolute w-full h-full rounded-3xl shadow-xl flex items-center justify-center text-white text-[3rem] font-bold"
                data-index={index}
                style={{
                  ...getImageStyle(index),
                  backgroundColor: getColorFromName(testimonial.name),
                }}
              >
